...
function (_React$Component) {
  ...
  function Avatar() {
    ...
    _this.setScale = function () {
      var childrenNode = _this.avatarChildren; // denominator is 0 is no meaning
  ...
  _createClass(Avatar, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (prevProps.children !== this.props.children || prevState.scale !== this.state.scale && this.state.scale === 1 || prevState.isImgExist !== this.state.isImgExist || !this.state.avatarDisplay) {
        this.setScale();
